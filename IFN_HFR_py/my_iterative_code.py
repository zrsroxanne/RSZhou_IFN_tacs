...
def get_adj_matrix(combine_hemi=False):
    ...
    adj_lh = adj_fs4['fs4_Firstadjacent_vertex_lh'].squeeze() # 注意减一的问题
    new_adj_matrix_l = []
    for i in range(adj_lh.shape[0]):
        new_adj_matrix_l.append(adj_lh[i].squeeze() - 1)

    adj_rh = adj_fs4['fs4_Firstadjacent_vertex_rh'].squeeze() # 注意减一的问题
    new_adj_matrix_r = []
...
if __name__ == "__main__":
    ...
    func_path_par = "/n01dat01/pdchen/pin_ind_net/Plos_ref/dataset/mcad/{}_timeframes_fs4.mat"
    tsnr_path_par = "/n01dat01/pdchen/pin_ind_net/Plos_ref/dataset/mcad_tsnr/{}_tsnr_fs4.mat"
    output_dir = '/n01dat01/pdchen/pin_ind_net/Plos_ref/IndiPar/mcad/Py/{}/'

    func_path_par = "D:/My_Work/pin_ind_net/Plos_ref/dataset/mcad/{}_timeframes_fs4.mat"
    tsnr_path_par = "D:/My_Work/pin_ind_net/Plos_ref/dataset/mcad_tsnr/{}_tsnr_fs4.mat"
    output_dir = 'D:/My_Work/pin_ind_net/Plos_ref/HFR_py/results/seperate/{}/'
    #subjects = np.loadtxt("/n01dat01/pdchen/pin_ind_net/Plos_ref/dataset/sub_list.txt",dtype='object').tolist()
    subjects = ['sub-0001']
    for sub in subjects:
        
        ts_path = func_path_par.format(sub)
        tsnr_path = tsnr_path_par.format(sub)
        output_dir = output_dir.format(sub)
